...
The following is a set of guidelines for contributing to `Simple`, which are hosted in the [mrinjamul/simple-jekyll](https://github.com/mrinjamul/simple-jekyll) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
